// Enhanced by AI on 2025-08-11T22:21:50.552Z
// Section: footer
// Category: footer
...
export default function Footer() {
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Size Guide", href: "/about#sizing" },
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Return Policy", href: "/about#return-policy" }
      ]
    }
  ]
  ...
  const socialLinks = [
    ...
    { name: "Pinterest", icon: Linkedin, href: "https://pinterest.com" }
  ]
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                <div className="size-10 rounded-lg bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center">
                  <Gem className="text-primary-foreground size-5" />
                </div>
                <span className="font-bold text-xl">Artisan Gems</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Handcrafted jewelry made with love and care. Each piece tells a unique story, 
                created with sustainable materials and traditional craftsmanship that celebrates artistry.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">+1 (555) 789-4563</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <MapPin className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">45 Artisan Way, Craftsville</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Subscribe for exclusive offers, new collection alerts, and artisan stories.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="hidden sm:inline flex items-center gap-1">
                Crafted with <Heart className="size-3 text-red-500 fill-current" /> by artisans
              </span>
            </div>
